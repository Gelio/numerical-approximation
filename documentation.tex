...
\begin{document}
	...
	\section{Przykłady}
	Przykłady zostały wygenerowane poprzez obliczenie danej funkcji aproksymowanej $f$ w węzłach, a następnie zaburzenie tych wartości poprzez dodanie szumu. Dopiero na tych zaburzonych wartościach wykonujemy aproksymację.
	...
	\begin{enumerate}[label=\textbf{Przykład \arabic*}]
		...
		W zależności od wylosowanego szumu aproksymacja dostosowuje się do węzłów aproksymacji i jest dość dokładna.
